...
public class TabComplete {
    ...
    static {
        ...
        tabListMap.put("ItemCommand.add", Arrays.asList("name", "lore", "type", "lore-exact", "customModelData", "condition", "trigger", "action", "price", "points", "levels" ,"permission", "required-amount", "cooldown"));
