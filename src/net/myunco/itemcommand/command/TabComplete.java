...
public class TabComplete {
    ...
    static {
        ...
        tabListMap.put("ItemCommand.add", Arrays.asList("name", "lore", "type", "lore-exact", "custom-model-data", "condition", "trigger", "action", "price", "points", "levels" ,"permission", "required-amount", "cooldown"));
